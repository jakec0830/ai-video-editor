...
$xxl = Get-ChildItem (Join-Path $FREECUT "whisper-xxl") -Recurse -Filter "faster-whisper-xxl.exe" -ErrorAction SilentlyContinue | Select-Object -First 1
...
# --- 5. 個人偏好檔 ---------------------------------------------------------
$prefTpl = Join-Path $KIT "我的剪輯偏好.範本.md"
...
Write-Host "然後把影片丟進來,說你想怎麼剪。詳見 README.md。"
